...
<div id="sales-receipt" class="sideNav bg-white" style="z-index:9999;">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="pull-right" style="float:right;">
                            <button id="print" class="btn btn-danger btn-md" type="button"><span><i
                                            class="fa fa-print pr-1"></i> Print</span></button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">
                                    <address>
                                        <h2 class="mb-0">
                                            <strong class="text-danger">{{ config('org.name') }}</strong>
                                        </h2>
                            ...
                            <div class="col-md-12">
                                <div class="pull-right text-right">
                                    <hr>
                                    <h3 class="pl-4 mb-2"><strong>Total:&nbsp;</strong><span class="naira">N</span><span
                                                id="sell-total"></span></h3>
                                    <h6 class="pl-4"><strong>Amount Paid:&nbsp;</strong><span
                                                class="naira">N</span><span id="amount-paid"></span></h6>
                                    <h6 class="pl-4"><strong>Remaining Balance:&nbsp;</strong><span
                                                class="naira">N</span><span id="paid-balance"></span></h6>
                                    <h6 class="pl-4"><strong>Change:&nbsp;</strong><span class="naira">N</span><span
                                                id="paid-change"></span></h6>
                                    <hr>
                                </div>
                                <div class="clearfix"></div>
                                <div class="text-center">
                                    <h5 class="text-uppercase">Thank you for buying from us</h5>
                                    <p class="text-muted">Returns are only accepted within 12 working hours from the
                                        time of purchase, on show of this receipt, and given that the item is in an
                                        acceptable good condition.</p>
                                </div>
                                <hr>
                            </div>
                        </div>
                                            ...
                                            <div>
                                                <header class="right-pane-header">
                                                    ...
                                                    <div class="search-box">
                                                        <input placeholder="Search products" id="txtProductSearch"
                                                               name="search">
                                                                ...
                                                                @foreach($products as $product)
                                                                    <div class="product" id="p-{{ $product->batch_id }}"
                                                                        ...
                                                                        <div class="product-img">
                                                                            ...
                                                                            <strong>
                                                                                <span style="text-decoration: line-through">N</span><span
                                                                                        class="price">{{ $product->retail_price }}</span>
                                                                            </strong>
                                                                        </span>
                                                                        </div>
...
<script type="text/javascript">
  ...
  */
  ...
  $(document).ready(function () {
    $(document).on('keyup', '#txtProductSearch', function (e) {
      searchBarcode(e);
    });
    ...
    $(".sell-button").click(function () {
      ...
      jqxhr.done(function (response, textStatus, jqXHR) {
        // Clear cart records from server session using ajax
        $.ajax({
        ...
        // var count = 1;  No need for the count
        ...
        var _address = ' '.replace(' ', '{{ config('org.address') }}');
        var _contact = ' '.replace(' ', '{{ config('org.contact') }}');
  ...
  function searchBarcode(e) {
    let barcode = $(e.target).val().toString().trim();
    if (barcode !== '') {
      $.ajax({
        ...
        success: function (data) {
          ...
          var productUrl = "{{ asset('/inventory/products/') }}" + "/";
          
          buildPOSProducts(variations, productUrl);
        }
      });
    } else {
      $.ajax({
  ...
  function buildPOSProducts(variations, url) {
  ...
  function AddProductToCart(values) {
    ...
    console.log('Adding Product. Quantity: ', quantity);
    ...
    jqxhr.done(function (response, textStatus, jqXHR) {
      ...
      if (response.new_batch_exists === "true" || response.new_batch_exists === "regular") {
        ...
        if (item_exists == null) {
          ...
          let qty = item_exists.firstElementChild.children[2].children[0].children[0]
          ...
          // console.log('Updating Product. Quantity: ', product_quantity);
